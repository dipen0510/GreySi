...
- (UIView *) makeDefaultCenterView {
  ...
  view.layer.shadowOffset = CGSizeMake(0, 3);
    ...
    UIImageView* centerButtonImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"centerButton.png"]];
    centerButtonImage.frame = CGRectMake(0, 0, 50.0, 50.0);
    [view addSubview:centerButtonImage];
