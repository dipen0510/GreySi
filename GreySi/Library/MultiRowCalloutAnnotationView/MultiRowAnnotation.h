...
+ (instancetype)annotationWithCoordinate:(CLLocationCoordinate2D)coordinate title:(NSString *)title calloutCells:(NSArray *)calloutCells subtitle:(NSString *)subtitle budget:(NSString *)budget;
- (instancetype)initWithCoordinate:(CLLocationCoordinate2D)coordinate title:(NSString *)title calloutCells:(NSArray *)calloutCells subtitle:(NSString *)subtitle budget:(NSString *)budget NS_DESIGNATED_INITIALIZER;
